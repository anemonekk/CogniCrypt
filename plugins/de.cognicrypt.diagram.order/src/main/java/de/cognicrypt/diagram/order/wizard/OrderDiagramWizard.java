...
import de.cognicrypt.core.Constants;
//import de.cognicrypt.diagram.order.Constants;
//import de.cognicrypt.core.Constants.CodeGenerators;
//import de.cognicrypt.diagram.order.controllers.FileUtilities;

public class OrderDiagramWizard extends Wizard {

	public OrderDiagramWizard() {
	...
	/*public boolean performFinish() {
		...
		final FileUtilities fileUtilities = new FileUtilities("test");
